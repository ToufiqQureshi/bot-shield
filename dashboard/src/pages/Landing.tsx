            ...
            <div className="grid md:grid-cols-12 gap-8 items-start">
              ...
              <div className="md:col-span-6">
                <div className="font-mono text-xs p-4 rounded" style={{ background: 'var(--bg-tertiary)', border: '1px solid var(--border-primary)' }}>
                  ...
                  <p className="mt-2">api.yoursite.com. → CNAME → proxy.hakaishield.io</p>
      ...
      <section className="border-t" style={{ borderColor: 'var(--border-primary)' }}>
        <div className="max-w-5xl mx-auto px-6 py-24">
          <div className="max-w-3xl">
            ...
            <p className="text-lg leading-relaxed mb-6" style={{ color: 'var(--text-secondary)' }}>
              hakaishield is in active development. We're looking for 10 companies to build this with us. You'll get early access, direct line to engineering, and founding customer pricing locked in forever.
            </p>
          ...
          <div className="grid md:grid-cols-12 gap-12">
            ...
            <div className="md:col-span-7 flex items-center">
              <div>
                ...
                <p className="text-lg leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
                  Use this calculator to estimate your exposure. Then point a CNAME at hakaishield and see the real numbers in your own traffic.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs" style={{ color: 'var(--text-muted)' }}>
                ...
                <li><a href="https://github.com/ToufiqQureshi/hakaishield" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">GitHub</a></li>
              </ul>
            </div>
            <div>

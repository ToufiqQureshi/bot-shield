    ...
    <div className="min-h-screen" style={{ background: 'var(--bg-primary)', color: 'var(--text-primary)' }}>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="prose max-w-none space-y-6 text-base leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
          ...
          <p>
            Email: <a href="mailto:toufiq@hakaishield.io" style={{ color: 'var(--accent-blue)' }}>toufiq@hakaishield.io</a>
          </p>
          <p>
            GitHub: <a href="https://github.com/ToufiqQureshi/hakaishield" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent-blue)' }}>github.com/ToufiqQureshi/hakaishield</a>
          </p>
        </div>
      </div>
    </div>

      ...
      <div className="min-h-screen" style={{ background: 'var(--bg-primary)', color: 'var(--text-primary)' }}>
        ...
        <div className="max-w-3xl mx-auto px-6 py-24 text-center">
          ...
          <p className="text-lg mb-8" style={{ color: 'var(--text-secondary)' }}>
            Thanks for your interest in hakaishield. I'll review your application and get back to you within 48 hours.
          </p>
    ...
    <div className="min-h-screen" style={{ background: 'var(--bg-primary)', color: 'var(--text-primary)' }}>
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <p className="text-lg mb-12" style={{ color: 'var(--text-secondary)' }}>
          We're looking for 10 companies to build hakaishield with. You'll get early access, founding pricing locked in forever, and direct line to engineering.
        </p>
        ...
        <div className="mt-16 pt-8 border-t" style={{ borderColor: 'var(--border-primary)' }}>
          <p className="text-sm" style={{ color: 'var(--text-muted)' }}>
            Prefer to chat first? Email me directly at <a href="mailto:toufiq@hakaishield.io" className="underline hover:text-white transition-colors">toufiq@hakaishield.io</a>
          </p>
        </div>
      </div>
    </div>

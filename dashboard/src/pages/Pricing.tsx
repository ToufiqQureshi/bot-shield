      ...
      <section className="border-t" style={{ borderColor: 'var(--border-primary)' }}>
        <div className="max-w-3xl mx-auto px-6 py-20">
          ...
          <div className="space-y-0">
            {[
              { q: 'How long does onboarding take?', a: '15 minutes. Add a CNAME record, verify domain ownership, and hakaishield is protecting your traffic. No code changes, no SDK, no install.' },

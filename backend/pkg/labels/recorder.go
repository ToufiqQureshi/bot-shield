...
// The proof is the challenge itself — real JavaScript, a real canvas
// render, no automation globals — which is independent of anything our
// own scoring decided about that request.
